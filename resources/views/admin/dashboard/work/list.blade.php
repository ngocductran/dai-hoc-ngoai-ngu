...
<div class="pd-20 card-box mb-30">
    <div class="clearfix mb-20">
        <div class="pull-left">
            <h4 class="h4">Quản lý công việc</h4>
        </div>
        <div class="pull-right">
            <a href="{{route('get.work.create')}}" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Thêm</a>
        </div>
    </div>  
    <hr>
    @if(session('success'))
                        ...
                        <td class="text-center">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                    ...
                                    <a class="dropdown-item" href="{{route('get.work.delete',$work->id)}}"><i class="dw dw-delete-3"></i> Delete</a>
                                </div>
                            </div>
                        </td>
                    </tr>
