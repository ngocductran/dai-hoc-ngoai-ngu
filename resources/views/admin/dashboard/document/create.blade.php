...
<div class="pd-20 card-box mb-30">
    <div class="clearfix">
        <div class="pull-left">
            <h4 class="text-blue h4">Thêm tài liệu</h4>
        </div>
    </div>
    <hr>
    ...
    <form method="POST" enctype="multipart/form-data" action="{{route('post.document.create')}}">
        {{ csrf_field() }}
        <div class="form-group row">
            <label class="col-sm-12 col-md-2 col-form-label">Tên tài liệu</label>
        ...
        <div class="form-group row">
            <label class="col-sm-12 col-md-2 col-form-label">Tài liệu</label>
            <div class="col-sm-12 col-md-10">
