...
<div class="pd-20 card-box mb-30">
    <div class="clearfix">
        <div class="pull-left">
            <h4 class="text-blue h4">Thêm thông tin phòng</h4>
        </div>
    </div>
    <hr>
    ...
    <form method="POST" enctype="multipart/form-data" action="{{route('post.intro.create')}}">
        {{ csrf_field() }}
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-md-6">
                <input type="file" class="form-control-file" oninput="pic.src=window.URL.createObjectURL(this.files[0])" name="file">
            </div>
            <div class="col-md-4">
